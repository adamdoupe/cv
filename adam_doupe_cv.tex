...
\cventry{2020--Present}{Acting Director}{Center for Cybersecurity
...
\cventry{2018--Present}{Founding Member}{Order of the Overflow}{Lead a group of hackers to organize the DEF CON Capture the Flag (CTF) competition, considered the ``Olympics'' of CTF. We host two competitions annually: DEF CON CTF Quals (which teams from all around the world play), and where the top teams from that competition compete in DEF CON CTF Finals, co-located with the DEF CON security conference.}{}{}
